...
module.exports = function(app, passport) {
	...
	app.post('/submitResults', function(req, res) {
		...
		disruptionSelection[0] = parseInt(req.body.A);
		disruptionSelection[1] = parseInt(req.body.B);
		disruptionSelection[2] = parseInt(req.body.C);
		disruptionSelection[3] = parseInt(req.body.D);
		disruptionSelection[4] = parseInt(req.body.E);
		disruptionSelection[5] = parseInt(req.body.F);
		disruptionSelection[6] = parseInt(req.body.G);
		disruptionSelection[7] = parseInt(req.body.J);
		disruptionSelection[8] = parseInt(req.body.K);
		disruptionSelection[9] = parseInt(req.body.L);
		disruptionSelection[10] = parseInt(req.body.M);
		disruptionSelection[11] = parseInt(req.body.N);
		for (var ii = 0; ii < rooms.length; ii++) {
			console.log(disruptionSelection[ii]);
